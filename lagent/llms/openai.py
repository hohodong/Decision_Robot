...
class GPTAPI(BaseAPILLM):
    ...
    def _chat(self, messages: List[dict], **gen_params) -> str:
        ...
        while max_num_retries < self.retry:
            ...
            try:
                ...
                # tmp_data1 = json.dumps(data, ensure_ascii=False)
                # tmp_data2 = json.dumps(data, ensure_ascii=True)
                # print(tmp_data1)
                # print(tmp_data2)
    ...
    def generate_request_data(self,
        ...
        elif model_type.lower().startswith('internlm') or model_type.lower().startswith('/root'):
            data = {
                'model': model_type,
                'messages': messages,
                'n': 1,
